...
; ERG> erg_ofa_matrix, span=1 ; 横軸１時間のPLOTを24枚作成し、erg\erg_ofa_matrix\erg_ofa_matrix_YYYYMMDD_HH.pngに保存
;
;--------------------------------------------------------------------
pro day_plot, span=span, hour_plot=hour_plot
  ...
  ;get_data, pr_matrix + 'Bx_Bz_132', data=s02 Eなし
  get_data, pr_matrix + 'Ey_Ex_132', data=sE10
  get_data, pr_matrix + 'Ey_Ey_132', data=sE11
  ;get_data, pr_matrix + 'By_Bz_132', data=s12 Eなし
  ;get_data, pr_matrix + 'Bz_Bx_132', data=s20 Eなし
  ;get_data, pr_matrix + 'Bz_By_132', data=s21 Eなし
  ;get_data, pr_matrix + 'Bz_Bz_132', data=s22 Eなし
  ...
  ;test
  ;試しにi番目のデータを見てみる
  ;vec_ = [[1,0,0],[0,1,0],[0,0,1]]
  ;i = 300 & vec_rot = rotmat[*,*,100] ## vec_ ## rotmat_t[*,*,100] & print, vec_rot


  ; *****************
  ; 7.2.analyze MGF data E
  ; *****************
  split_vec, 'erg_mgf_l2_mag_64hz_sgi'
...
;    store_data, 'erg_mepe_l2_3dflux_FEDU_pa', newname='mepe_PA_10keV'
    erg_mep_part_products, 'erg_mepe_l2_3dflux_FEDU',outputs='energy', pitch=[0.,3.], mag_name='erg_mgf_l2_mag_8sec_dsi', pos_name='erg_orb_l2_pos_gse', /no_ang_weight
;    stop
...
;    store_data, 'erg_mepe_l2_3dflux_FEDU_pa', newname='mepe_PA_41keV'
    erg_mep_part_products, 'erg_mepe_l2_3dflux_FEDU',outputs='energy', pitch=[177.,188.], mag_name='erg_mgf_l2_mag_8sec_dsi', pos_name='erg_orb_l2_pos_gse', /no_ang_weight
...
;    store_data, 'erg_mepe_l2_3dflux_FEDU_pa', newname='mepe_PA_72keV'
    erg_mep_part_products, 'erg_mepe_l2_3dflux_FEDU',outputs='energy', pitch=[3.,37.5], mag_name='erg_mgf_l2_mag_8sec_dsi', pos_name='erg_orb_l2_pos_gse', /no_ang_weight
...
;    tplot, ['hfa_e_Bmodels', 'ofa_e_Bmodels', 'ofa_b_Bmodels']
    ...
    ylim,  'erg_pwe_ofa_l2_matrix_Btotal_132_gyro', 0.064, 20.0, 1
    zlim,  'erg_pwe_ofa_l2_matrix_Btotal_132_gyro', 1e-4, 1e4, 1
    store_data, 'erg_pwe_ofa_l2_matrix_Btotal_132_gyro', newname='ofa_b_gyro'
...
;    tplot, ['hfa_e','ofa_e', pr_matrix + 'Btotal_132', 'kvec_mask', 'polarization_mask'] + '_gyro'
    ...
    options, ['hfa_e_gyro', 'ofa_e_gyro', 'ofa_b_gyro', 'kvec_mask_gyro', 'polarization_mask_gyro', 'mepe_PA_0-3', 'mepe_PA_177-188', 'mepe_PA_3-37', 'mepe_ET'], 'datagap', 60.0

    tplot, ['hfa_e_gyro', 'ofa_e_gyro', 'ofa_b_gyro', 'kvec_mask_gyro', 'polarization_mask_gyro', 'mepe_PA_0-3', 'mepe_PA_177-188', 'mepe_PA_3-37', 'mepe_ET']
