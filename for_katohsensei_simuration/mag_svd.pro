...
; Added by Ampuku.
; 磁場のWaveformに対してOFAのオンボード処理を行った後、magnetic SVD method[Santolik eτ al., 2003]で伝搬角解析を行う
...
;===============================
            ...
            for j=1,n_elements(freq)-2 do begin ; 移動平均数に合わせて最初と最後を変更
            
                indx_f=j+indgen(3)-1 ; 3点移動平均 平均数に合わせてindgen(3)-1を変更
                ; indx_f=j ; 上手に変えれば周波数方向に移動平均できる
