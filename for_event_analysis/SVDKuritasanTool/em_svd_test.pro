...
makewave_multiple,wna=wna_inp,phi=phi_inp
...
;===============================
        ...
        cut_f=max(scw_fft_all_data.y)*0.5

        get_data, 'waveangle_th_emsvd', data=data, dlim=dlim, lim=lim
        data.y[where(scw_fft_all_data.y LT cut_f)] = 'NaN'
        store_data, 'waveangle_th_emsvd_mask', data={x:data.x, y:data.y, v:data.v}, dlim=dlim, lim=lim
        get_data, 'waveangle_phi_emsvd', data=data, dlim=dlim, lim=lim
        data.y[where(scw_fft_all_data.y LT cut_f)] = 'NaN'
        store_data, 'waveangle_phi_emsvd_mask', data={x:data.x, y:data.y, v:data.v}, dlim=dlim, lim=lim
        get_data, 'planarity_emsvd', data=data, dlim=dlim, lim=lim
        data.y[where(scw_fft_all_data.y LT cut_f)] = 'NaN'
        store_data, 'planarity_emsvd_mask', data={x:data.x, y:data.y, v:data.v}, dlim=dlim, lim=lim

        mask_tname = tnames('*_mask')
        ylim, mask_tname, 0, 1000, 0
