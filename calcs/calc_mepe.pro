pro calc_mepe
    ...
    store_data, 'mepe_PA_0-3', data={x:data.x, y:data.y, v:data.v/1000.} ;V->keV
    ...
    get_data, 'erg_mepe_l2_3dflux_FEDU_energy', data=data
    store_data, 'mepe_PA_177-188', data={x:data.x, y:data.y, v:data.v/1000.} ;V->keV
    ...
    get_data, 'erg_mepe_l2_3dflux_FEDU_energy', data=data
    store_data, 'mepe_PA_3-37', data={x:data.x, y:data.y, v:data.v/1000.} ;V->keV
