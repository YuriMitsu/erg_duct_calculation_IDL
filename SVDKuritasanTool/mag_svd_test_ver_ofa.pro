...
; Added by Ampuku.
; .compile '/Users/ampuku/Documents/duct/code/IDL/SVDKuritasanTool/mag_svd_test_ver_ofa.pro'
...
pro mag_svd_test_ver_ofa,wna_inp=wna_inp,phi_inp=phi_inp,rate_inp=rate_inp,enr=enr,bnr=bnr,f_average=f_average,t_average=t_average

makewave_mul_ver_ofa,wna=wna_inp,phi=phi_inp,rate=rate_inp,enr=enr,bnr=bnr
print, 'use makewave_mul_ver_ofa'
